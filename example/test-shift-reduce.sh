...
run "../src/bin/evaluate-lader -attach_null right $ALIGN_IN $OUTPUT data/$TEST_IN $TARGET_IN'' > output/$TEST_IN.srdp.grade 2> output/$TEST_IN.srdp.grade.log"

tail -n3 output/$TEST_IN.srdp.grade
