...
public:
    ...
    TestHyperGraph() : 
        ...
        tsr->AddHypothesis(new Hypothesis(6,0, 1,0,-1,2,HyperEdge::EDGE_ROOT,-1,0,-1,ts01));
        tsr->AddHypothesis(new Hypothesis(6,0, 0,1,-1,2,HyperEdge::EDGE_ROOT,-1,1,-1,ts01));
        tsr->AddHypothesis(new Hypothesis(6,0, 0,1,-1,2,HyperEdge::EDGE_ROOT,-1,2,-1,ts01));
        // Add the features
        FeatureVectorInt 
...
//					cerr << "Hypothesis " << *hyp << endl;
    ...
    int TestProcessOneSpan() {
        ...
        stack00->AddHypothesis(new Hypothesis(1,1, 0,0,0,0, HyperEdge::EDGE_FOR));
        graph.SetStack(0, 0, stack00);
        stack11->AddHypothesis(new Hypothesis(2,2, 1,1,1,1, HyperEdge::EDGE_FOR));
        ...
        graph.ProcessOneSpan(model, set, datas, 0, 1, 100);
		...
		stack22->AddHypothesis(new Hypothesis(3,3, 2,2,2,2, HyperEdge::EDGE_FOR));
		graph.SetStack(2, 2, stack22);
//		graph.SetStack(0, 1, stack01);
		TargetSpan *stack12 = new TargetSpan(1,2);
		stack12->AddHypothesis(new Hypothesis(4,4, 1,2,2,1, HyperEdge::EDGE_BAC));
