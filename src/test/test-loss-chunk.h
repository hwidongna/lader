...
public:
    ...
    bool RunTest()
    {
        ...
        cout << "TestStraightNonterminal()" << endl;
        if(TestStraightNonterminal())
            succeeded++;
        ...
        cout << "TestInvertedNonterminal()" << endl;
        if(TestInvertedNonterminal())
            succeeded++;
        ...
        cout << "TestStraightTerminal()" << endl;
        if(TestStraightTerminal())
            succeeded++;
        ...
        cout << "TestInvertedTerminal()" << endl;
        if(TestInvertedTerminal())
            succeeded++;
        ...
        cout << "TestCalculateSentenceLoss()" << endl;
        if(TestCalculateSentenceLoss())
            succeeded++;
